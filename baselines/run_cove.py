...
def _cove_get_internal_answer(question: str, model_name: str, config: dict) -> str:
    prompt = COVE_VERIFICATION_ANSWER_NO_RAG_TEMPLATE.format(question=question)
...
def run_cove_no_rag(query: str, model_name: str, config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        for q in verification_questions:
            ...
            verification_results.append({'question': q, 'answer': answer, 'retrieved_docs': None})
            logging.debug(f"      Q: {q}\n        A: {answer[:100]}...")
